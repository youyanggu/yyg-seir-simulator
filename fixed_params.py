...
MIN_MORTALITY_MULTIPLIER = 0.5 # for a 0.995 mortality mutliplier, this kicks in after ~3.5 months for 0.75, ~6 months for 0.5
...
HOSPITALIZATION_RATE = 0.03 # based on 2020-06-15 CDC MMWR report of hospitalizations being ~3x the death rate: https://www.cdc.gov/mmwr/volumes/69/wr/mm6924e2.htm
DAYS_IN_HOSPITAL = 11
...
IMMUNITY_MULTIPLIER_US_SUBREGION = 0.25
DAYS_UNTIL_LOCKDOWN_FATIGUE = 28
MAX_POST_REOPEN_R = 1.15
